...
export default function AdminLoginZrx() {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-background via-background to-primary/10">
        ...
        <form onSubmit={handleSubmit} className="card-3d rounded-3xl bg-card p-6 space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="pl-11 h-12 rounded-xl" placeholder="admin@example.com" required />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} className="pl-11 pr-11 h-12 rounded-xl" placeholder="••••••••" required />
